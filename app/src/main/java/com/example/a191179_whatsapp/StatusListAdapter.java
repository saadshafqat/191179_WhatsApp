...
public class StatusListAdapter extends RecyclerView.Adapter<StatusListAdapter.ViewHolder> {
    private List<StatusModelList> modelLists;
    private Context context;

    public StatusListAdapter(List<StatusModelList> modelLists, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=layoutInflater.inflate(R.layout.status_list,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final StatusModelList modelList = modelLists.get(position);
